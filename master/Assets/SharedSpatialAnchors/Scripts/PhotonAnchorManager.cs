...
public class PhotonAnchorManager : PhotonPun.MonoBehaviourPunCallbacks
{
    ...
    {
        SampleController.Instance.Log("Photon: Joined default lobby.");

        var roomOptions = new PhotonRealtime.RoomOptions { IsVisible = true, MaxPlayers = 16, EmptyRoomTtl = 0, PlayerTtl = 300000 };

        PhotonPun.PhotonNetwork.JoinOrCreateRoom(nomeDaSala, roomOptions, PhotonRealtime.TypedLobby.Default);
    ...
    public override void OnJoinedRoom()
    {
        ...
        AnchorMenu.instance.shareButton.SetActive(true);
    ...
    public void PublishAnchorUuids(Guid[] uuids, uint numUuids, bool isBuffered)
    {
        ...
        var rpcTarget = isBuffered ? PhotonPun.RpcTarget.OthersBuffered : PhotonPun.RpcTarget.OthersBuffered;
